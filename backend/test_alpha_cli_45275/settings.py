"""
Django settings for test_alpha_cli_45275 project.
...
ROOT_URLCONF = 'test_alpha_cli_45275.urls'
...
WSGI_APPLICATION = 'test_alpha_cli_45275.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_alpha_cli_45275 API",
    "DESCRIPTION": "API documentation for test_alpha_cli_45275 App",
    "VERSION": "v1",
}
